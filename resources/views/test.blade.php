...
<head>
    ...
    <!-- Google Fonts -->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/css/font.css") }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/css/icon.css") }}" rel="stylesheet" type="text/css" />

    <!-- Bootstrap Core Css -->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/plugins/bootstrap/css/bootstrap.min.css") }}" rel="stylesheet" type="text/css" />

    <!-- Waves Effect Css -->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/plugins/node-waves/waves.css") }}" rel="stylesheet" type="text/css" />

    <!-- Animation Css -->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/plugins/animate-css/animate.css") }}" rel="stylesheet" type="text/css" />

    <!-- Morris Chart Css-->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/plugins/morrisjs/morris.css") }}" rel="stylesheet" type="text/css" />

    <!-- Custom Css -->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/css/style.css") }}" rel="stylesheet" type="text/css" />

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="{{ asset("/bower_components/adminbsb-materialdesign/css/themes/all-themes.css") }}" rel="stylesheet" type="text/css" />
...
<!-- Jquery Core Js -->
<script src="{{ asset ("/bower_components/adminbsb-materialdesign/js/jquery-3.1.1.min.js") }}"></script>
