...
module.exports = function(Chart) {
	...
	Chart.Scale = Chart.Element.extend({
		...
		draw: function(chartArea) {
			...
			// Make sure we draw text in the correct color and font.css
	...
	var LinearScale = Chart.LinearScaleBase.extend({
		...
		getTickLimit: function() {
			...
			if (me.isHorizontal()) {
				...
				// The factor of 2 used to scale the font.css size has been experimentally determined.
...
module.exports = function(Chart) {
	...
	var defaultConfig = {
		...
		pointLabels: {
			//Number - Point label font.css size in pixels
			fontSize: 10,
	...
	var LinearRadialScale = Chart.LinearScaleBase.extend({
		...
		getDistanceFromCenterForValue: function(value) {
			...
			// Take into account half font.css size + the yPadding of the top value
